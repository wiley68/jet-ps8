...
>
    ...
    <input
        type="hidden"
        id="jet_card_products_id"
        name="jet_card_products_id"
        value="{$jet_products_id}"
    />
    <input
        type="hidden"
        id="jet_card_products_qt"
        name="jet_card_products_qt"
        value="{$jet_products_qt}"
    />
    <input
        type="hidden"
        id="jet_card_products_pr"
        name="jet_card_products_pr"
        value="{$jet_products_pr}"
    />
    <input
        type="hidden"
        id="jet_card_products_ct"
        name="jet_card_products_ct"
        value="{$jet_products_ct}"
    />
    <input
        type="hidden"
        id="jet_card_products_vr"
        name="jet_card_products_vr"
        value="{$jet_products_vr}"
    />

    <div
        id="jet_card_alert_overlay"
        class="jet_alert_overlay"
    ></div>
    <div class="jet_panel">
        <div class="jet_row">
        ...
        <div class="jet_row">
            ...
            <div class="jet_column_right">
                <input
                    type="hidden"
                    id="jet_card_priceall_input"
                    name="jet_card_priceall_input"
                />
        ...
        <div class="jet_row">
            ...
            <div class="jet_column_right">
                ...
                >
                    <option
                        value="3"
                        {if $jet_vnoski == 3}selected{/if}
                    >3 месеца</option>
                    <option
                        value="6"
                        {if $jet_vnoski == 6}selected{/if}
                    >6 месеца</option>
                    <option
                        value="9"
                        {if $jet_vnoski == 9}selected{/if}
                    >9 месеца</option>
                    <option
                        value="10"
                        {if $jet_vnoski == 10}selected{/if}
                    >10 месеца</option>
                    <option
                        value="12"
                        {if $jet_vnoski == 12}selected{/if}
                    >12 месеца</option>
                    <option
                        value="15"
                        {if $jet_vnoski == 15}selected{/if}
                    >15 месеца</option>
                    <option
                        value="18"
                        {if $jet_vnoski == 18}selected{/if}
                    >18 месеца</option>
                    <option
                        value="24"
                        {if $jet_vnoski == 24}selected{/if}
                    >24 месеца</option>
                    <option
                        value="30"
                        {if $jet_vnoski == 30}selected{/if}
                    >30 месеца</option>
                    <option
                        value="36"
                        {if $jet_vnoski == 36}selected{/if}
                    >36 месеца</option>
                </select>
            </div>
        </div>
        <div class="jet_row">
            ...
            <div class="jet_column_right">
                <input
                    type="hidden"
                    id="jet_total_credit_price_input"
                    name="jet_total_credit_price_input"
                />
                {if $jet_eur == 0 or $jet_eur == 3}
                    <div class="jet_input_text jet_disable">
        ...
        <div class="jet_row">
            ...
            <div class="jet_column_right">
                <input
                    type="hidden"
                    id="jet_card_vnoska_input"
                    name="jet_card_vnoska_input"
                />
                {if $jet_eur == 0 or $jet_eur == 3}
                    <div class="jet_input_text jet_disable">
        ...
        <div class="jet_row">
            ...
            <div class="jet_column_right">
                <input
                    type="hidden"
                    id="jet_card_gpr_input"
                    name="jet_card_gpr_input"
                />
                <div class="jet_input_text jet_disable">
        ...
        <div class="jet_row">
            ...
            <div class="jet_column_right">
                <input
                    type="hidden"
                    id="jet_card_obshto_input"
                    name="jet_card_obshto_input"
                />
                {if $jet_eur == 0 or $jet_eur == 3}
                    <div class="jet_input_text jet_disable">
