<form action="{$jet_action_card}" method="post">
    <input type="hidden" id="jet_card_price" name="jet_card_price" value="{$jet_price}" />
    <input type="hidden" id="jet_card_products_id" name="jet_card_products_id" value="{$jet_products_id}" />
    <input type="hidden" id="jet_card_products_qt" name="jet_card_products_qt" value="{$jet_products_qt}" />
    <input type="hidden" id="jet_card_products_pr" name="jet_card_products_pr" value="{$jet_products_pr}" />
    <input type="hidden" id="jet_card_products_ct" name="jet_card_products_ct" value="{$jet_products_ct}" />
    <input type="hidden" id="jet_card_products_vr" name="jet_card_products_vr" value="{$jet_products_vr}" />

    <div id="jet_card_alert_overlay" class="jet_alert_overlay"></div>
    <div class="jet_panel">
        <div class="jet_row">
            ...
            <div class="jet_column_right">
                <input class="jet_input_text_active" type="number" min="0" id="jet_card_parva"
                    name="jet_card_parva_input" value=0 />
                <button type="button" id="jet_card_btn_preizcisli" class="jet_button_preizcisli">Преизчисли</button>
            </div>
        </div>
        <div class="jet_row">
            <div class="jet_column_left">
        ...
        <div class="jet_row">
            ...
            <div class="jet_column_right">
                <select id="jet_card_vnoski" name="jet_card_vnoski_input" class="jet_input_text">
        ...
        <div class="jet_row">
            ...
            <div class="jet_column_right">
                <input type="hidden" id="jet_card_glp_input" name="jet_glp_input" />
                <div class="jet_input_text jet_disable">
        ...
        <div class="jet_row">
            ...
            <div class="jet_column_right">
                <input class="jet_input_text_active jet_left" type="text" id="jet_card_egn" name="jet_card_egn"
                    maxlength="10" />
            </div>
        </div>
        ...
        <div class="jet_row_footer">
            <div style="padding-bottom: 5px;">
                <input type="checkbox" name="jet_card_uslovia" value="1" id="jet_card_uslovia" class="jet_uslovia" />
                &nbsp;&nbsp;&nbsp;
            ...
            <div>
                <input type="checkbox" name="jet_card_uslovia1" value="1" id="jet_card_uslovia1" class="jet_uslovia" />
                &nbsp;&nbsp;&nbsp;
            ...
            <button type="submit" id="jet_card_btn_pay" disabled class="btn btn-primary">Изпрати заявката</button>
        </div>
    </div>
</form>