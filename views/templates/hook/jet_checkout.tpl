...
>
    ...
    <input
        type="hidden"
        id="jet_products_id"
        name="jet_products_id"
        value="{$jet_products_id}"
    />
    <input
        type="hidden"
        id="jet_products_qt"
        name="jet_products_qt"
        value="{$jet_products_qt}"
    />
    <input
        type="hidden"
        id="jet_products_pr"
        name="jet_products_pr"
        value="{$jet_products_pr}"
    />
    <input
        type="hidden"
        id="jet_products_ct"
        name="jet_products_ct"
        value="{$jet_products_ct}"
    />
    <input
        type="hidden"
        id="jet_products_vr"
        name="jet_products_vr"
        value="{$jet_products_vr}"
    />

    <div
        id="jet_alert_overlay"
    ...
    <div class="jet_panel">
        ...
        <div class="jet_row">
            ...
            <div class="jet_column_right">
                <input
                    type="hidden"
                    id="jet_priceall_input"
                    name="jet_priceall_input"
                />
