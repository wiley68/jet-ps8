<div
    ...
    class="jet_product_button_container"
>
    <input
        type="hidden"
        id="jet_price"
        ...
        <tr>
            <td class="jet_button_table">
                <img
                    id="btn_jet"
                    class="jet_logo"
                    src="{$module_dir}views/templates/img/jet.png"
            ...
            <tr>
                <td class="jet_button_table">
                    <img
                        id="btn_jet_card"
                        class="jet_logo"
                        src="{$module_dir}views/templates/img/jet_card.png"
...
<div
    id="jet-product-popup-container"
    class="{$modalpayment_jet}"
>
